...
const ImageCard = (props) => {
    ...
    const displayClass = props.imageUrl == null ? "block" : "none";
    ...
    return (
        <div id={props.id} className={styles["image-card"]}>
            <div className={styles["container"]} style={{ backgroundImage: "url('" + URL.createObjectURL(files[0]) +"')"}}>
                <div className={styles["placeholder"] + " " + styles[displayClass]} onClick={props.onClickAddImage}>
            ...
            <form encType="multipart/form-data">
                <input type="file" id="myfile" name="myfile" accept="image/*" onChange={saveImage}></input>
            </form>
            <div className={styles["remove-icon"] + " " + styles[displayClass]} onClick={props.onRemoveImage}>
