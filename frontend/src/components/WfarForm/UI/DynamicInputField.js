...
const DynamicInputField = (props) => {
    ...
    const onRemoveHandler = () => {
        props.onRemoveInput(props.index);
    }

    return (
        <div className={styles['input-field-container'] + " " + styles[isLastClass] + " " + styles[validationClass]}>
            
            <div className={styles['input-field-container-flex']}>
                <input
                    type="text"
                    id={props.id}
                ...
                {/* add */}
                <svg className={styles['ic-input-add']} onClick={props.onAddInput} width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
