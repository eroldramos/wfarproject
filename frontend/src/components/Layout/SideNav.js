		...
		<Fragment>
			<div id="side-nav">
				<ul className="side-nav-ul">
					...
					<li className={`nav-menu-item ${window.location.pathname == "/dashboard/"
						? "nav-menu-item--active"
						: ""}`}
						onClick={onNavigateToDashboard} title="Dashboard">
						<svg
							width="20"
							height="22"
							viewBox="0 0 20 22"
					...
					{userInfo.isAdmin &&
						<li className={`nav-menu-item ${window.location.pathname == "/manage-semesters/" ||
							window.location.pathname == "/manage-semesters/archives/"
							? "nav-menu-item--active"
							: ""}`}
							onClick={onNavigateToManageSemesters} title="Manage Semesters">
							<svg
								width="20"
								height="19"
								viewBox="0 0 20 19"
					...
					<li className={`nav-menu-item ${window.location.pathname == "/facultySubmission/" || window.location.pathname == "/facultySubmission/overview" || window.location.pathname == "/facultySubmission/weekly-view"
						? "nav-menu-item--active"
						: ""}`}
						onClick={onNavigateToFacultySubmission} title="Faculty Submissions">
						<svg
							width="20"
							height="20"
							viewBox="0 0 20 20"
					...
					{!userInfo.isAdmin &&
						<li className={`nav-menu-item ${window.location.pathname == "/mySubmission/" ||
							window.location.pathname == "/mySubmission/archived" ||
							window.location.pathname == "/mySubmission"
							? "nav-menu-item--active"
							: ""}`}
							onClick={onNavigateToMySubmission} title="My Submissions">
							<svg
								width="20"
								height="20"
								viewBox="0 0 20 20"
					...
					<li
						className={`nav-menu-item ${window.location.pathname == "/manage-faculty/department-head/"
							? "nav-menu-item--active"
							: ""
							}`}
						onClick={onNavigateToManageFaculties} title="Manage Faculties">
						<svg
							width="20"
							height="20"
							viewBox="0 0 20 20"
					...
					<li
						className={`nav-menu-item ${window.location.pathname == "/pending-accounts/"
							? "nav-menu-item--active"
							: ""
							}`}
						onClick={onNavigateToPendingAccounts} title="Pending Accounts">
						<svg
							width="20"
							height="20"
							viewBox="0 0 20 20"
