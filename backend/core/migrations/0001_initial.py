# Generated by Django 4.0.4 on 2022-05-07 02:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_checker_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='faculty_checker_id', to=settings.AUTH_USER_MODEL)),
                ...
                ('week_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='week_id', to='core.week')),
            ],
        ),
        migrations.CreateModel(
            name='WFAR_Entry',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('accomplishment_date', models.DateTimeField(default=datetime.datetime.now)),
